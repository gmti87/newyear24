...
var newyear =  new Date(y, m, d, hs, min, s);
var newyearc = newyear.getTime();
...
function virada() {
    ...
    if (gap > 0) {
        document.getElementById("cd").innerHTML = "Falta(m) " + d + " d " + h + " Hs " + m + " m " + s + " s";    
    }
    else {
        document.getElementById("cd").innerHTML = "Meu desejo a você";
    }
}
